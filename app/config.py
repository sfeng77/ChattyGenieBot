...
class Settings(BaseSettings):
    ...
    history_prune_threshold_items: int = Field(24, alias="HISTORY_PRUNE_THRESHOLD_ITEMS")
    history_keep_last_items: int = Field(8, alias="HISTORY_KEEP_LAST_ITEMS")
    ...
    session_idle_expiry_hours: float = Field(12.0, alias="SESSION_IDLE_EXPIRY_HOURS")
    session_tool_result_max_chars: int = Field(600, alias="SESSION_TOOL_RESULT_MAX_CHARS")
